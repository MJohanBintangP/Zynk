  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 px-4 sm:mt-20 mt-12 sm:pb-28 text-center">
      ...
      <div className="flex flex-row gap-4 mt-4 items-center">
        <Link to="/News">
          <button className="cursor-pointer hover:scale-105 transition-transform bg-[#0033FF] text-white px-8 py-2 rounded-[12px] text-sm sm:text-base">Mulai</button>
        </Link>
        <Link to="/News#hotNews">
          <button className="cursor-pointer hover:scale-105 transition-transform border-2 border-white px-6 py-2 rounded-[14px] text-sm sm:text-base">Berita hangat</button>
        </Link>
      </div>
    </div>
  );
